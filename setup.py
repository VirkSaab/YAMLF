...
setup(
  ...
  url = 'virksaab.github.io',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/VirkSaab/YAMLF/archive/v_01.tar.gz',    # I explain this later on
